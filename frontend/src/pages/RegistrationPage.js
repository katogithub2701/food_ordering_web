      ...
      <div className="auth-modal">
        ...
        <form className="auth-form restaurant-form" onSubmit={handleSubmit}>
          <div style={{ textAlign: 'center', marginBottom: '12px' }}>
            ...
            <h2 className="auth-title" style={{ marginBottom: '4px', fontSize: '1.3rem' }}>Đăng ký tài khoản nhà hàng</h2>
          </div>
          ...
          {(error || message) && (
            <div className={error ? 'auth-error' : message.includes('thành công') ? 'auth-success' : 'auth-error'} style={{ marginBottom: '12px' }}>
              {error || message}
            </div>
          )}
          
          <button type="submit" className="auth-btn-main" disabled={loading} style={{ padding: '12px', fontSize: '1rem' }}>
